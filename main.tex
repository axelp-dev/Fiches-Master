...
% \include{subjects/Probabilites/main_probabilites}

% \part[images/part_simulation.pdf]{Simulation Aléatoire}
% \setcounter{chapter}{0}
% \include{subjects/Simulation_Aleatoire/main_simulation}

% \part[]{Statistiques}
% \setcounter{chapter}{0}
% \include{subjects/Statistiques/main_Stats}

% \part[images/part_algorithmique.pdf]{Algorithmique}
% \setcounter{chapter}{0}
% \include{subjects/Algorithmique/main_algo}

% \part[]{Apprentissage Automatique}
% \setcounter{chapter}{0}
% \include{subjects/DeepLearning/main_deepLearning}

% \part[]{Mathématiques du Machine Learning}
% \setcounter{chapter}{0}
% \include{subjects/Mathematiques_ML/main_mathematiques_du_ml}

% \part[]{Informatique Graphique}
% \setcounter{chapter}{0}
% \include{subjects/Informatique_Graphique/main_informatique_graphique}

\part[]{Planification}
\setcounter{chapter}{0}
\include{subjects/Planification/main_planification}

% \part[]{Traitement du signal}
% \setcounter{chapter}{0}
% \include{subjects/Traitement_Signal/main_traitement_signal}

% --------- ARCHIVES ---------

% \part[images/part_optimisation.pdf]{Optimisation}
% \setcounter{chapter}{0}
% \include{subjects/Optimisation/main_optimisation}

% \part[]{Compilation}
% \setcounter{chapter}{0}
% \include{subjects/Compilation/main_compilation}

% \part[]{Raisonnement sur des connaissances hiérarchiques et/ou imparfaites}
% \setcounter{chapter}{0}
% \include{subjects/RCHI/main_RCHI}
