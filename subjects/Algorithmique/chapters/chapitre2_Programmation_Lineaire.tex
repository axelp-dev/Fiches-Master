...
Intéressons nous maintetant aux problèmes de programmation linéaire. Même si le nom peut prêter à confusion, 
...
\begin{example}
    ...
    Voici les expressions mathémartiques de ces deux programmes :  
...
\begin{definition}[Relaxation linéaire]
    ...
    La \emph{relaxation linéaire} de ce programme consiste à supprimer les contraintes d’intégralité :
    \[
        x_j \in \R_+ \quad \forall j \in \llbracket 1, n \rrbracket
    \]
...
L'algorithme \emph{Branch and Bound} construit un arbre de recherche binaire dont la racine est le 
...
\subsection{Techniques de modélisation}