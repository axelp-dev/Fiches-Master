...
Or ici, on suppose l'existence d'une probabilité. Définissons la notion de pari pour nous 
...
\begin{definition}[Croyance et Plausibilité]
    ...
    \begin{itemize}
        \item \textbf{La croyance} $Bel$ définie par : 
            \begin{equation}
                \boxed{\forall A \in \mathcal{P}( \Omega), \quad Bel(A) = \sum_{B \in \mathcal{P}( \Omega) \mid B \subset A} m(B)} 
            \end{equation}
            qui estime dans quelle mesure un évènement $A$ est certain. 
        \item \textbf{La plausibilité} $pl$ définie par : 
            \begin{equation}
                \boxed{\forall A \in \mathcal{P}( \Omega), \quad pl(A) = \sum_{B \in \mathcal{P}( \Omega) \mid B \cap A \not = 0} m(B)}
            \end{equation}
...
\begin{definition}[Coupure de niveau]
    ...
    de $ \Sigma$ comme l'ensemble : 
        \begin{equation}
            \displaystyle \Sigma_\alpha := \{ ( \varphi, \alpha) \in \Sigma \mid \alpha_i \geqslant \alpha\}
        \end{equation}
\end{definition}
